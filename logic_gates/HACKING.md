...
hidden if the `logic_gates_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `logic_gates_DEVELOPER_MODE` to the configure
...
Runs the executable target `logic_gates_exe`.
